    ...
    <main className="page-shell">
      <header className="flex min-w-0 flex-col gap-6 border-b border-slate-800 pb-8 lg:flex-row lg:items-end lg:justify-between">
        <div className="min-w-0 max-w-2xl">
          ...
          <p className="mt-3 max-w-2xl text-base leading-7 text-slate-400">Mulai dengan persona, isi topik, lalu setujui draft secara manual jika sudah sesuai.</p>
        </div>
      ...
      <section className="mt-10" aria-labelledby="setup-title">
        <div className="mb-4 max-w-2xl"><h2 id="setup-title" className="text-xl font-semibold tracking-tight text-white">1. Siapkan studio</h2><p className="mt-1 text-sm leading-6 text-slate-400">Persona diperlukan untuk draft. Pola adalah contoh tambahan bila kamu memilikinya.</p></div>
