...
Rules: the title must sound like a spoken thread opening, never a news/article headline. Start the body with a short first-person observation using the persona's own first-person vocabulary when provided. Show a small uncertainty or process of thought (for example, 'awalnya', 'gw kira', 'jangan-jangan', or 'baru kepikiran') before concluding. Leave one specific tension or detail unresolved; do not force a broad closing question. Branch through real human concerns such as heat, guests, timing, discomfort, or a small worry before a reference appears; never take the shortest path from topic to product. Persona should guide the narrator's thinking, not force repeated words such as community, culture, creative, perspective, space, or process. Follow Observe -> Wonder -> Hypothesis -> Reference -> Open Question. If a URL exists, mention the reference title or a distinctive part of it before the URL and explain the connection in that same thought. Never append a bare URL or write 'Referensi yang gue maksud'. If the topic and reference cannot be truthfully connected, shift to their real shared context; never use an unrelated reference. Never write marketplace listing language, unsupported garment specifications, or claims presented as firsthand experience without evidence, and never add an unsupported conclusion about a community. Never write 'klik sekarang', 'beli', 'promo', urgency claims, or an unverified person/product endorsement. Treat patterns labeled 'Negative lesson' or scored naturalness 2 or lower as anti-patterns to avoid, never as writing examples. Treat naturalness 4 or higher patterns as structural guidance only; never copy their wording.`,
      maxTokens: 1100,
      json: true,
    });
...
Fix every reviewer failure. Open with the persona's first-person voice and a concrete information gap. Show the narrator thinking or doubting before the conclusion. Keep every activity, object, and environment in one believable scene unless an explicit comparison bridge is present. Replace abstract metaphors and generic adjectives with a specific sensory observation. Make the title conversational, not journalistic. Follow at least one real concern before introducing the reference; remove shopping transitions, marketplace descriptions, unsupported garment specifications, persona keyword cosplay, unsupported community conclusions, and product-led closing questions. If there is a URL, name its reference context before the URL and make the connection explicit.`,
        maxTokens: 900,
        json: true,
      });
