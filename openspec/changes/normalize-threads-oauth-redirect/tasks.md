...
- [ ] 2.2 Run `npm run build` and deploy the API production target.
- [ ] 2.3 Verify the callback route no longer returns an invalid-header 500 and archive the OpenSpec change.
