...
#### Scenario: Metadata-only product page
- **WHEN** a public product page provides only a listing title
- **THEN** the response returns low-confidence, metadata-only angles about a bounded human situation and does not copy the listing title or product properties into the topic
