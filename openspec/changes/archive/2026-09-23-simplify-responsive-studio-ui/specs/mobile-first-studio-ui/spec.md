...
- **THEN** the primary creator sequence and its actions appear in order, optional content can be expanded by keyboard, and no content or action is clipped horizontally
...
- **THEN** the introduction explains the creator sequence and the next action in plain language within one short reading measure

#### Scenario: Creator reads a workflow section

- **WHEN** a workflow section is visible or expanded
